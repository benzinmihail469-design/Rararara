...
-- ==========================================
pcall(function()
    if CoreGui:FindFirstChild("HoshiMM2Gui") then 
        CoreGui.HoshiMM2Gui:Destroy() 
    end
...
CloseBtn.MouseButton1Click:Connect(function()
    ...
    local root = GetRoot() if root then root.AssemblyAngularVelocity = Vector3.new(0,0,0) end 
    ScreenGui:Destroy()
end)
