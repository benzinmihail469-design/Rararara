--[[
    ...
    РАБОЧИЙ ПОЛЗУНОК НА UIDragDetector
--]]
...
-- Белый ползунок (Frame с UIDragDetector)
...
-- UIDragDetector - двигает ползунок только по горизонтали
...
-- Клик по фону слайдера двигает ползунок
...
print("ESP + Speed loaded! UIDragDetector slider - 100% working! Drag white circle or click track.")
