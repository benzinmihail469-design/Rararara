...
local function NormalizeText(str)
    ...
    local cyrUpper = {"А","Б","В","Г","Д","Е","Ё","Ж","З","И","Й","К","Л","М","Н","О","П","Р","С","Т","У","Ф","Х","Ц","Ч","Ш","Щ","Ъ","Ы","Ь","Э","Ю","Я"} -- FIXED: текст
    local cyrLower = {"а","б","в","г","д","е","ё","ж","з","и","й","к","л","м","н","о","п","р","с","т","у","ф","х","ц","ч","ш","щ","ъ","ы","ь","э","ю","я"} -- FIXED: текст
    for i = 1, #cyrUpper do
        lowerStr = lowerStr:gsub(cyrUpper[i], cyrLower[i])
    end

    local synonyms = {
        ["настройки"] = "settings", ["язык"] = "language", ["тема"] = "theme", ["шрифт"] = "font" -- FIXED: текст
    }
...
TabTitle.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
TabTitle.TextWrapped = true -- FIXED TEXT
...
ControlsContainer.ZIndex = 100 -- FIXED: кнопка сворачивания -- FIXED: кнопка закрытия

local MinBtn = Instance.new("TextButton", ControlsContainer)
MinBtn.Size = UDim2.new(0, 24, 0, 24)
MinBtn.Position = UDim2.new(0, 0, 0, 3)
MinBtn.Text = "-" -- FIXED: текст
MinBtn.Font = Enum.Font.GothamBold
MinBtn.TextSize = 14
MinBtn.TextColor3 = Color3.fromRGB(180, 180, 180)
MinBtn.BackgroundTransparency = 1
MinBtn.Active = true -- FIXED: кнопка сворачивания
MinBtn.ZIndex = 101 -- FIXED: кнопка сворачивания
MinBtn.TextWrapped = true -- FIXED TEXT

local CloseBtn = Instance.new("TextButton", ControlsContainer)
CloseBtn.Size = UDim2.new(0, 24, 0, 24)
CloseBtn.Position = UDim2.new(0, 30, 0, 0)
CloseBtn.Text = "X" -- FIXED: текст
CloseBtn.Font = Enum.Font.GothamBold
CloseBtn.TextSize = 14
CloseBtn.TextColor3 = Color3.fromRGB(180, 180, 180)
CloseBtn.BackgroundTransparency = 1
CloseBtn.Active = true -- FIXED: кнопка закрытия
CloseBtn.ZIndex = 101 -- FIXED: кнопка закрытия
CloseBtn.TextWrapped = true -- FIXED TEXT
...
ClearSearchBtn.Text = "X" -- FIXED: текст
...
ClearSearchBtn.TextWrapped = true -- FIXED TEXT
...
SearchBox.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
SearchBox.ZIndex = 7
SearchBox.TextWrapped = true -- FIXED TEXT
...
HubTitle.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
HubTitle.ZIndex = 5
HubTitle.TextWrapped = true -- FIXED TEXT
...
SubTitle.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
SubTitle.ZIndex = 5
SubTitle.TextWrapped = true -- FIXED TEXT
...
EmbeddedControls.ZIndex = 100 -- FIXED: кнопка сворачивания -- FIXED: кнопка закрытия
...
EmbMinBtn.Text = "-" -- FIXED: текст
EmbMinBtn.Font = Enum.Font.GothamBold
EmbMinBtn.TextSize = 12
EmbMinBtn.TextColor3 = Color3.fromRGB(180, 180, 180)
EmbMinBtn.BackgroundTransparency = 1
EmbMinBtn.Active = true -- FIXED: кнопка сворачивания
EmbMinBtn.ZIndex = 101 -- FIXED: кнопка сворачивания
EmbMinBtn.TextWrapped = true -- FIXED TEXT
...
EmbCloseBtn.Text = "X" -- FIXED: текст
EmbCloseBtn.Font = Enum.Font.GothamBold
EmbCloseBtn.TextSize = 12
EmbCloseBtn.TextColor3 = Color3.fromRGB(180, 180, 180)
EmbCloseBtn.BackgroundTransparency = 1
EmbCloseBtn.Active = true -- FIXED: кнопка закрытия
EmbCloseBtn.ZIndex = 101 -- FIXED: кнопка закрытия
EmbCloseBtn.TextWrapped = true -- FIXED TEXT
...
DiscordLabel.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
DiscordLabel.TextWrapped = true -- FIXED TEXT
...
StatsLabel.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
StatsLabel.TextWrapped = true -- FIXED TEXT
...
MinBtn.MouseButton1Click:Connect(ToggleMinimize) -- FIXED: кнопка сворачивания
EmbMinBtn.MouseButton1Click:Connect(ToggleMinimize) -- FIXED: кнопка сворачивания
...
CloseBtn.MouseButton1Click:Connect(CloseGui) -- FIXED: кнопка закрытия
EmbCloseBtn.MouseButton1Click:Connect(CloseGui) -- FIXED: кнопка закрытия
        ...
        if type(data) == "table" then
            if data.Type == "Toggle" then
                if typeof(data.IsEnabled) == "function" and data.IsEnabled() then
                    ...
                    if data.Checkbox and data.Checkbox.Parent then tween(data.Checkbox, {BackgroundColor3 = isLightMode and Color3.fromRGB(210, 210, 210) or Color3.fromRGB(40, 40, 40)}) end
...
local Localization = {
    ...
    ["Русский"] = { -- FIXED: текст
        ["Settings"] = "Настройки", ["UI"] = "Интерфейс", ["Theme"] = "Тема", -- FIXED: текст
        ["UISize"] = "Размер интерфейса", ["UITransparency"] = "Прозрачность меню", -- FIXED: текст
        ["MenuFont"] = "Шрифт меню", ["Language"] = "Язык", ["AntiAFK"] = "Анти-АФК", ["UITheme"] = "Тема UI", -- FIXED: текст
        ["AnimatedWindow"] = "Анимированное окно", ["Gradient"] = "Градиентный фон" -- FIXED: текст
    }
}
...
function Library:CreateDropdown(parentPage, textKey, options, default, callback)
    ...
    TitleLabel.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
    TitleLabel.BackgroundTransparency = 1
    TitleLabel.ZIndex = 8
    TitleLabel.TextWrapped = true -- FIXED TEXT
    ...
    SelectedLabel.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
    SelectedLabel.BackgroundTransparency = 1
    SelectedLabel.ZIndex = 8
    SelectedLabel.TextWrapped = true -- FIXED TEXT
    ...
    Arrow.ZIndex = 8
    Arrow.TextWrapped = true -- FIXED TEXT
    ...
    local function populateOptions(newOptions)
        ...
        for i, option in ipairs(options) do
            ...
            OptLabel.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
            OptLabel.BackgroundTransparency = 1
            OptLabel.ZIndex = 10
            OptLabel.TextWrapped = true -- FIXED TEXT
            ...
            Checkmark.ZIndex = 10
            Checkmark.TextWrapped = true -- FIXED TEXT
...
function Library:CreateButton(parentPage, textKey, callback)
    ...
    Btn.TextSize = 13
    Btn.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
    ...
    Btn.TextWrapped = true -- FIXED TEXT
...
function Library:CreateToggle(parentPage, textKey, default, callback)
    ...
    TglLabel.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
    TglLabel.BackgroundTransparency = 1
    TglLabel.ZIndex = 7
    TglLabel.TextWrapped = true -- FIXED TEXT
...
function Library:CreateSlider(parentPage, textKey, min, max, default, callback)
    ...
    SliderLabel.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
    SliderLabel.BackgroundTransparency = 1
    SliderLabel.ZIndex = 7
    SliderLabel.TextWrapped = true -- FIXED TEXT
    ...
    ValueLabel.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
    ValueLabel.BackgroundTransparency = 1
    ValueLabel.ZIndex = 7
    ValueLabel.TextWrapped = true -- FIXED TEXT
...
function Library:CreatePage(textKey, iconId, layoutOrder)
    ...
    TabBtn.TextTruncate = Enum.TextTruncate.AtEnd -- FIXED: текст
    TabBtn.ZIndex = 7
    TabBtn.TextWrapped = true -- FIXED TEXT
...
local LanguageDropdown = Library:CreateDropdown(SettingsPage, "Language", {"English", "Русский"}, "English", function(selectedLang) -- FIXED: текст
